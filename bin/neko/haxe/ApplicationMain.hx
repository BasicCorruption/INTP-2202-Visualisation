...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("INTP-2202-Visualisation", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("INTP-2202-Visualisation", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "18";
		app.meta["company"] = "BasicCorruption";
		app.meta["file"] = "INTP-2202-Visualisation";
		app.meta["name"] = "INTP-2202-Visualisation";
